...
int main(int argc, char** argv)
{
	...
	while (node.ok())
	{
		...
		try
		{
		        listener.waitForTransform("/tb3_2", "fake2", ros::Time(0), ros::Duration(3.0));
			listener.lookupTransform("/tb3_2", "fake2", ros::Time(0), transform12);
		...
		try
		{
		        listener.waitForTransform("fake2", "/tb3_2", ros::Time(0), ros::Duration(3.0));
			listener.lookupTransform("fake2", "/tb3_2", ros::Time(0), transform21);
